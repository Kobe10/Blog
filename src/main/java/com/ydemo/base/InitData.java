...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        List<User> users = userRepository.findAllByNativeSql("select * from t_user u where u.username='17611221957' ", new User(),null);
        ...
        Role role  = new Role();
        role.setName("17611221957");
        roleRepository.save(role);

        User user = new User();
        user.setCreatedate(new Date());
        user.setUsername("17611221957");
        user.setPassword(new BCryptPasswordEncoder().encode("dazhi592681026"));
    ...
    public static void main(String[] args) {
        System.out.println(new BCryptPasswordEncoder().encode("dazhi592681026"));
    }
}
